...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EDVANA — Government Polytechnic Kolhapur" },
      {
        name: "description",
        content:
          "Student Management Information System for Government Polytechnic Kolhapur — profile, exams, results, fees and more.",
      },
      { property: "og:title", content: "EDVANA — Government Polytechnic Kolhapur" },
      {
